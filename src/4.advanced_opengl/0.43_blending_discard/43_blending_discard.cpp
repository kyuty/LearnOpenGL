// 43_blending_discard.cpp : 定义控制台应用程序的入口点。
//
...
int main()
{
	...
	Shader shader("shaders/blending_discard.vert", "shaders/blending_discard.frag");
...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Cubes
		glBindVertexArray(cubeVAO);
		glBindTexture(GL_TEXTURE_2D, cubeTexture);  // We omit(忽略) the glActiveTexture part since TEXTURE0 is already the default active texture unit. (a single sampler used in fragment is set to 0 as well by default)		
